...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=3.5in]{annotated_roomb.png}
...
The experiment was written in python using the Vizard environemnt.  Tracking was done using IntersenseTracker
The HMD we used was a Proview HMD with the following attirbutes. ....  Fill this in.
The computer we used was a Dell with the following specs...........  Fill this in
