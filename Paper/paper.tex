...
% should we include data from older generation??

% look at analysis from mean.

% time tracking: fov, deadlen significant.  interaction is weird....

% num times lost: fov not significant, deadlen significant, interaction -- talk about what interaction means.
