...
\keywords{
augmented reality, immersion, user study, simulation 
}
...
\begin{CRcatlist}
  \CRcat{I.3.7}{Computer Graphics}{Three-Dimensional Graphics and Realism}{Augmented Reality};
...
%Figure \ref{fig:anova} gives the results of this analysis.
...
%, with results shown in Figure \ref{fig:anova}.
...
%\begin{figure*}[t]
%	\centering
%	\subfigure[]{\label{subfig:low}\includegraphics[width=1.5in]{figures/numtimes_deadlen_lowfov.pdf}}
%	\subfigure[]{\label{subfig:med}\includegraphics[width=1.5in]{figures/numtimes_deadlen_medfov.pdf}}
%	\subfigure[]{\label{subfig:upp}\includegraphics[width=1.5in]{figures/numtimes_deadlen_uppfov.pdf}}
%	\caption{\label{fig:interaction}Box plots relating sensor dropout length to the number of times the participant loses the target, with (a) low, (b) medium and (c) upper field of view.}
%\end{figure*}

%\begin{figure}[h]
%	\centering
%	\includegraphics[width=1.5in]{figures/extra.pdf}
...
\begin{figure*}[t]
	...
	\subfigure[]{\label{subfig:med}\includegraphics[width=1.5in]{figures/numtimes_deadlen_medfov.pdf}}
	\subfigure[]{\label{subfig:upp}\includegraphics[width=1.5in]{figures/numtimes_deadlen_uppfov.pdf}}
	\subfigure[]{\label{subfig:extra}\includegraphics[width=1.5in]{figures/extra.pdf}}
...
%Figure \ref{fig:tt_deadlen} shows a box plot of time following target versus dropout length.
...
%This threshold on dropouts would change depending on the task at hand, but we expect the same pattern would arise in other target following scenarios.
