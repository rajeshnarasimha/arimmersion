...
\begin{figure*}[t]
	\centering
	\subfigure[]{\label{subfig:low}\includegraphics[width=1.7in]{figures/numtimes_deadlen_lowfov.pdf}}
	\subfigure[]{\label{subfig:med}\includegraphics[width=1.7in]{figures/numtimes_deadlen_medfov.pdf}}
	\subfigure[]{\label{subfig:upp}\includegraphics[width=1.7in]{figures/numtimes_deadlen_uppfov.pdf}}
	\subfigure[]{\label{subfig:extra}\includegraphics[width=1.7in]{figures/extra.pdf}}
